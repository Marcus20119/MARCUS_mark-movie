    ...
    <Fragment>
      <div className="z-[100] fixed top-0 left-0 right-0 h-[56px] flex justify-between items-center bg-[#181818] px-2 shadow-2xl">
        <div ref={nodeRef}>
          ...
          {show && (
            <Fragment>
              <div className="z-[200] fixed top-0 left-0 h-screen w-[70%] gap-[40px] flex flex-col bg-[#181818] py-[40px] px-[20px] text-white border-r-[1px] border-r-[#353338] slide-from-left">
              ...
              <div
                className="z-[190] fixed inset-0 bg-black fade-in"
                onClick={() => setShow(false)}
              >
                &nbsp;
              </div>

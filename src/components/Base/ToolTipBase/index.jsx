...
const ToolTipBase = ({
  tipMessage = '',
  className = '',
  tipClassName = 'bg-black px-4 py-2 rounded-lg text-white',
  children,
}) => {
  ...
  return (
    <Fragment>
      ...
      <CSSTransition in={show} timeout={200} classNames="fade" unmountOnExit>
        ...
        >
          {tipMessage}
          <div className="absolute bottom-0 left-2/4 -translate-x-2/4 translate-y-[6px] border-[12px] border-b-black border-r-black border-t-transparent border-l-transparent rounded-[4px] rotate-45"></div>
        </PortalWrapper>
      </CSSTransition>
    </Fragment>
  );
